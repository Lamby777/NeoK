...
public final class CmdList
{
	...
	public final OnActionCmd onActionCmd = new OnActionCmd();
	public final OnInvFullCmd onInvFullCmd = new OnInvFullCmd();
	...
	public final SpambotCmd spambotCmd = new SpambotCmd();
